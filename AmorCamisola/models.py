...
class Produto(models.Model):
    ...
    vendedor = models.ForeignKey(User, on_delete=models.CASCADE, field_name='user')
...
class Chuteiras(models.Model):
    SIZE_CHOICES = (
    36, 36.5, 37, 37.5, 38, 38.5, 39, 39.5, 40, 40.5, 41, 41.5, 42, 42.5, 43, 43.5, 44, 44.5, 45, 45.5, 46, 46.5, 47)
    id = models.ForeignKey(Produto, on_delete=models.CASCADE, primary_key=True)
